...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/practice-areas.css') }}">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="category-card">
                                <div class="category-header">
                                    ...
                                    <span class="category-stats">{{ $category->case_count }} cases</span>
                                </div>
                                ...
                                <div class="cases-list">
                                    ...
                                    @if($category->case_count > 3)
                                        <div class="text-center mt-2">
                                            <small class="text-muted">+{{ $category->case_count - 3 }} more cases</small>
                                        </div>
                                    @endif
                                </div>
                                
                                <div class="action-buttons">
                                    <button class="btn-action btn-delete" onclick="deleteCategory('{{ $category->category }}')">
                                        <i class="fas fa-trash"></i> Delete
                                    </button>
                                    <button class="btn-action btn-view" onclick="viewCategoryCases('{{ $category->category }}')" data-bs-toggle="modal" data-bs-target="#viewCasesModal">
                                        <i class="fas fa-eye"></i> View Cases
                                    </button>
                                    <button class="btn-action btn-add" onclick="setAddCaseCategory('{{ $category->category }}')" data-bs-toggle="modal" data-bs-target="#addCaseModal">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach($categories as $category)
                                            <tr id="category-row-{{ md5($category->category) }}">
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" 
                                                           id="category-{{ md5($category->category) }}" 
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button class="btn btn-sm btn-danger" 
                                                                onclick="deleteCategoryFromTable('{{ $category->category }}')">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addCaseForm').addEventListener('submit', function(e) {
                ...
                fetch('{{ route("practice-areas.storeCase") }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}',
