...
@section('title', 'Lawyer Office Requests')
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="{{ asset('logo6.png') }}" alt="LegalConnect" width="30" height="30" class="me-2">
            LegalConnect - Lawyer Dashboard
        </a>
        <div class="navbar-nav ms-auto">
            <span class="navbar-text me-3">
                Welcome, {{ Auth::check() ? Auth::user()->name : 'Lawyer' }} ({{ Auth::check() ? Auth::user()->role : 'lawyer' }})
            </span>
    ...
    <div class="container">
        <div class="stats-container">
            ...
            <div class="dashboard-card approved">
                <div class="card-number">{{ $approvedAppointments }}</div>
                <div class="card-title">
            ...
            <div class="dashboard-card denied">
                <div class="card-number">{{ $deniedAppointments }}</div>
                <div class="card-title">
