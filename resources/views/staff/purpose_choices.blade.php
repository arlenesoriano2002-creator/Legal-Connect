...
<body>
    <div class="container">
        <!-- Back Button -->
        <div class="back-btn">
            <a href="{{ route('staff.walkins.logs') }}" class="btn btn-secondary">
        ...
        <div class="card">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fas fa-list me-2"></i>Available Purposes ({{ $purposes->count() }})
                </h5>
    ...
    <div class="modal fade" id="addPurposeModal" tabindex="-1" aria-labelledby="addPurposeModalLabel">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('staff.purpose.choices.store') }}" method="POST">
                    @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-btn').click(function() {
                ...
                $('#editPurposeForm').attr('action', '{{ route("staff.purpose.choices.update", "") }}/' + id);
