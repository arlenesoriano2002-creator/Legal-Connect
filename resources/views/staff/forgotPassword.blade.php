                    ...
                    <div class="settings-wrapper">
                        <div class="settings-card recovery-card">
                            ...
                            @if ($isEmailStep)
                                ...
                                <form method="POST" action="{{ route('staff.account.settings.forgot-password.send') }}">
                                    @csrf
                                    ...
                                    <div class="actions d-flex gap-2">
                                        <a href="{{ route('staff.account.settings') }}" class="btn btn-secondary btn-lg w-50">Back to Settings</a>
                            ...
                            @if ($isVerifyStep)
                                ...
                                <form method="POST" action="{{ route('staff.account.settings.forgot-password.verify.submit') }}">
                                    @csrf
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="actions d-flex gap-2">
                                        <a href="{{ route('staff.account.settings.forgot-password.email') }}" class="btn btn-secondary btn-lg w-50">Change Email</a>
                            ...
                            @if ($isResetStep)
                                ...
                                <form method="POST" action="{{ route('staff.account.settings.forgot-password.reset.submit') }}">
                                    @csrf
                                    ...
                                    <div class="actions d-flex gap-2">
                                        <a href="{{ route('staff.account.settings.forgot-password.verify') }}" class="btn btn-secondary btn-lg w-50">Back to Verification</a>
