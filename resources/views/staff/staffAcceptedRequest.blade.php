       ...
       <!-- Sidebar -->
        ...
        <div id="page-content-wrapper">
            ...
            <div class="dashboard-container">
                ...
                <!-- Filters -->
                <form method="GET" action="{{ route('staff.acceptedRequests') }}" class="row mb-4" id="filterForm">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('staff.acceptedRequests') }}" class="btn btn-secondary">
                            ...
                            <table class="table table-hover" id="acceptedAppointmentsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr id="appointment-{{ $appointment->id }}">
                                        ...
                                        <td>
                                            <button class="btn btn-info btn-sm view-btn" data-id="{{ $appointment->id }}" data-details-url="{{ route('staff.acceptedRequests.details', $appointment->id) }}">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="btn btn-danger btn-sm delete-btn" 
                                                    data-id="{{ $appointment->id }}"
                                                    data-delete-url="{{ route('staff.acceptedRequests.destroy', $appointment->id) }}"
