...
<body>
  ...
  @endphp
    ...
    <header>
      ...
      <nav id="main-nav">
            ...
            <a href="{{ url('/testimonial') }}" class="admin-login active">Testimonials</a>
 ...
 <section class="hero">
     <img class="bg-img" src="{{ asset('a.jpg') }}" alt="Hero background image" loading="lazy" />
        ...
        <div class="reviews-scroll">
          @forelse($reviews as $review)
            <div class="review-card" style="margin-bottom:16px;">
              ...
              @endphp
              <img src="{{ $review->image ? asset('uploads/reviews/'.$imagePath) : asset('default-user.png') }}"
            ...
            <form id="reviewForm" enctype="multipart/form-data">
                ...
                @if(Auth::check())
                    <div class="mb-4">
                        ...
                        <input  class="textInput" type="text" id="name" name="name" value="{{ Auth::user()->name }}" readonly class="form-input" />
                    </div>
