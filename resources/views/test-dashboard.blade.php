...
<body>
    <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="user-badge">
                        ...
                        <span>{{ $user->name ?? 'User' }} (ID: {{ $user->id }})</span>
                    </div>
                </div>
        ...
        <div class="test-grid">
            ...
            <div class="test-card">
                ...
                <div class="test-card-body">
                    ...
                    <div class="test-card-footer">
                        <a href="{{ route('test.connection') }}" class="btn-test btn-test-primary" target="_blank">
            ...
            <div class="test-card">
                ...
                <div class="test-card-body">
                    ...
                    <div class="test-card-footer">
                        <a href="{{ route('test.auth') }}" class="btn-test btn-test-primary" target="_blank">
                            <i class="fas fa-external-link-alt"></i> Test
                        </a>
                    </div>
                </div>
            ...
            <div class="test-card">
                ...
                <div class="test-card-body">
                    ...
                    <div class="test-card-footer">
                        <a href="{{ route('test.broadcasting') }}" class="btn-test btn-test-primary" target="_blank">
                            <i class="fas fa-external-link-alt"></i> Test
                        </a>
                    </div>
                </div>
            ...
            <div class="test-card">
                ...
                <div class="test-card-body">
                    ...
                    <div class="test-card-footer">
                        <a href="{{ route('test.database') }}" class="btn-test btn-test-primary" target="_blank">
                            <i class="fas fa-external-link-alt"></i> Test
                        </a>
                    </div>
                </div>
            ...
            <div class="test-card">
                ...
                <div class="test-card-body">
                    ...
                    <div class="test-card-footer">
                        <a href="{{ route('test.call-controller') }}" class="btn-test btn-test-primary" target="_blank">
                            <i class="fas fa-external-link-alt"></i> Test
                        </a>
                    </div>
                </div>
            ...
            <div class="test-card">
                ...
                <div class="test-card-body">
                    ...
                    <div class="test-card-footer">
                        <a href="{{ route('test.call-page') }}" class="btn-test btn-test-primary" target="_blank">
                            <i class="fas fa-external-link-alt"></i> Test
                        </a>
                    </div>
                </div>
            ...
            <div class="test-card">
                ...
                <div class="test-card-body">
                    ...
                    <div class="test-card-footer">
                        <a href="{{ route('test.broadcasting-auth') }}" class="btn-test btn-test-primary" target="_blank">
                            <i class="fas fa-external-link-alt"></i> Test
                        </a>
                    </div>
                </div>
            ...
            <div class="test-card">
                ...
                <div class="test-card-body">
                    ...
                    <div class="test-card-footer">
                        <a href="{{ route('test.webrtc') }}" class="btn-test btn-test-primary" target="_blank">
                            <i class="fas fa-external-link-alt"></i> Test
                        </a>
                    </div>
                </div>
        ...
        <div class="footer-text">
            <p>LegalConnect WebRTC System Test Dashboard | Last Updated: {{ now()->format('Y-m-d H:i:s') }}</p>
        </div>
    </div>
