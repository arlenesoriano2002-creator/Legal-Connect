                    ...
                    <section class="dashboard-grid">
                        <article class="dashboard-card">
                            <div>
                                ...
                                <div class="card-value">{{ $totalLawyers }}</div>
                            </div>
                            <div class="card-meta">
                        ...
                        <article class="dashboard-card">
                            <div>
                                ...
                                <div class="card-value">{{ $totalLawOffices }}</div>
                            </div>
                            <div class="card-meta">
                            ...
                            <div class="row gy-3">
                                <div class="col-12">
                                    ...
                                    <div class="progress" style="height: 12px; border-radius: 999px;">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: {{ min(100, $todayAppointments * 10) }}%"></div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="progress" style="height: 12px; border-radius: 999px;">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: {{ min(100, $pendingAppointments * 10) }}%"></div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="progress" style="height: 12px; border-radius: 999px;">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: {{ min(100, $approvedAppointments * 10) }}%"></div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
