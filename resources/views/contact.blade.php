...
<body>
  ...
  @endphp
      ...
      <nav id="main-nav">
            ...
            <a href="{{ url('/contact') }}" class="admin-login active">Contact</a>
  ...
  <div class="contact-content">
    ...
    <div class= "maps">
      ...
      <div class="contact-right1" aria-label="Office building photo and location map">
        <img src="{{ asset('location1.2.jpg') }}" alt="Hero backgroung image"/>
      </div>
    </div>
  </div>
</section>
  ...
  <form class="message-form" action="{{ route('message.store') }}" method="POST" novalidate>
    ...
    <div class="form-row">
      <div class="form-group">
        ...
        <input class="textInput" id="name" name="name" type="text" placeholder="Name" value="{{ old('name') }}" required />
        @error('name')
    ...
    <div class="form-row">
      <div class="form-group full-width">
        ...
        <input class="textInput" id="subject" name="subject" type="text" placeholder="Subject" value="{{ old('subject') }}" />
        @error('subject')
          <span class="error-message" style="color: #dc3545; font-size: 0.875rem; display: block; margin-top: 5px;">
            <i class="fas fa-exclamation-circle"></i> {{ $message }}
          </span>
    ...
    <div class="form-row">
      <div class="form-group full-width">
        ...
        <textarea id="message" name="message" placeholder="Message" rows="4">{{ old('message') }}</textarea>
        @error('message')
          <span class="error-message" style="color: #dc3545; font-size: 0.875rem; display: block; margin-top: 5px;">
            <i class="fas fa-exclamation-circle"></i> {{ $message }}
          </span>
