...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/register.blade.css')); ?>">
                            ...
                            <div class="left-column">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-input" placeholder="Fullname (Firstname, M.I, Surname)" required
                                        oninput="validateFullName(event)" value="<?php echo e(old('name')); ?>">
                                ...
                                <div class="form-group">
                                    <div class="phone-input-container">
                                        <select name="country_code" id="country_code" class="country-code-select" onchange="updatePhoneNumberLimit()">
                                            <option value="+63" <?php echo e(old('country_code') == '+63' ? 'selected' : ''); ?>>+63 Philippines</option>
                                            <option value="+1" <?php echo e(old('country_code') == '+1' ? 'selected' : ''); ?>>+1 USA/Canada</option>
                                            <option value="+44" <?php echo e(old('country_code') == '+44' ? 'selected' : ''); ?>>+44 UK</option>
                                            <option value="+61" <?php echo e(old('country_code') == '+61' ? 'selected' : ''); ?>>+61 Australia</option>
                                            <option value="+81" <?php echo e(old('country_code') == '+81' ? 'selected' : ''); ?>>+81 Japan</option>
                                            <option value="+86" <?php echo e(old('country_code') == '+86' ? 'selected' : ''); ?>>+86 China</option>
                                            <option value="+91" <?php echo e(old('country_code') == '+91' ? 'selected' : ''); ?>>+91 India</option>
                                            <option value="+49" <?php echo e(old('country_code') == '+49' ? 'selected' : ''); ?>>+49 Germany</option>
                                            <option value="+33" <?php echo e(old('country_code') == '+33' ? 'selected' : ''); ?>>+33 France</option>
                                            <option value="+34" <?php echo e(old('country_code') == '+34' ? 'selected' : ''); ?>>+34 Spain</option>
                                            <option value="+39" <?php echo e(old('country_code') == '+39' ? 'selected' : ''); ?>>+39 Italy</option>
                                            <option value="+7" <?php echo e(old('country_code') == '+7' ? 'selected' : ''); ?>>+7 Russia</option>
                                            <option value="+82" <?php echo e(old('country_code') == '+82' ? 'selected' : ''); ?>>+82 South Korea</option>
                                            <option value="+55" <?php echo e(old('country_code') == '+55' ? 'selected' : ''); ?>>+55 Brazil</option>
                                            <option value="+52" <?php echo e(old('country_code') == '+52' ? 'selected' : ''); ?>>+52 Mexico</option>
                                        </select>
                                        <input type="text" name="phone_number" class="form-input phone-number-input" placeholder="Phone number" required
                                            id="phone_number" oninput="validatePhoneNumber(event)" value="<?php echo e(old('phone_number')); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" class="form-input" placeholder="Address" required value="<?php echo e(old('address')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="right-column">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-input" placeholder="Email" required value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="textLoginDescription">
                        <p>Already have an account?</p><a href="<?php echo e(url('/login')); ?>" class="signup-text">Log-in</a>
                    </div>
                </form>
            </div>
        </div>
...
</html><?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\register.blade.php ENDPATH**/ ?>