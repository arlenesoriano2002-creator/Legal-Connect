...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/adminAcceptedRequest.blade.css')); ?>">
        <style>
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="page-content">
                <div class="header-container">
                    ...
                    <div class="search-container" style="justify-content: flex-end; align-items: center; gap: 12px; flex-wrap: wrap;">
                        ...
                        <button
                            ...
                            data-report-url="<?php echo e(route('adminAcceptedRequest.report.pdf')); ?>"
                        >
                ...
                <!-- Filters -->
                <form method="GET" action="<?php echo e(route('adminAcceptedRequest')); ?>" class="row mb-4">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="<?php echo e(route('adminAcceptedRequest')); ?>" class="btn btn-secondary">
                        ...
                        <tbody>
                           <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e(ucfirst($appointment->appointment_approval)); ?></td>
                                <td>
                                    <button class="info-btn view-btn" title="See Info" data-id="<?php echo e($appointment->id); ?>">
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\adminAcceptedRequest.blade.php ENDPATH**/ ?>