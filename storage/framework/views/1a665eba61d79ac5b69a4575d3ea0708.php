...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/staff/staffAccountSetting.blade.css')); ?>">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-xl-8">
                        <div class="settings-wrapper">
                            ...
                            <!-- Profile Update Form -->
                            <form method="POST" action="<?php echo e(route('staff.account.settings.update')); ?>" enctype="multipart/form-data" id="profileForm">
                                <?php echo csrf_field(); ?>
        ...
        <div class="modal fade" id="changePasswordModal" tabindex="-1" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo e(route('staff.account.settings.update.password')); ?>" id="passwordForm">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-2">
                                        <a href="<?php echo e(route('staff.account.settings.forgot-password.email')); ?>" class="text-decoration-none small fw-semibold">
                                            Forgot Password?
                                        </a>
                                    </div>
                                </div>
...
<!-- Bootstrap Modal for Logout Confirmation -->
  ...
  <script src="<?php echo e(asset('js/staff/staffAccountSetting.js')); ?>"></script>
  <?php
  ...
  ?>
  <div id="pageMeta"
       data-initial-avatar-url="<?php echo e($initialAvatarUrl); ?>"
       data-user-id="<?php echo e($user->id); ?>"></div>
   <script>
...
function resetForm() {
    ...
    if (INITIAL_AVATAR_URL) {
        avatarPreview.innerHTML = `<img src="${INITIAL_AVATAR_URL}" alt="<?php echo e($user->name); ?>" id="avatarImage" class="img-fluid rounded-circle">`;
    } else {
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\staff\staffAccountSetting.blade.php ENDPATH**/ ?>