...
<html>
<head>
    <title>Re: <?php echo e($reply_subject); ?> - LegalConnect</title>
</head>
<body>
    <h2>Message Reply from LegalConnect</h2>
    
    <p>Dear <?php echo e($inquiry_name); ?>,</p>
    ...
    <div style="border-left: 4px solid #007bff; padding: 15px; background-color: #f8f9fa; margin: 20px 0;">
        <h3 style="margin-top: 0;"><?php echo e($reply_subject); ?></h3>
        <p style="white-space: pre-wrap; line-height: 1.6;"><?php echo e($reply_message); ?></p>
    </div>
    
    <p>If you have any further questions or need additional assistance, please feel free to contact us.</p>
    
    <p>Best regards,<br><strong><?php echo e($sender_name); ?></strong><br><strong>LegalConnect Team</strong></p>
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\emails\inquiry_reply.blade.php ENDPATH**/ ?>