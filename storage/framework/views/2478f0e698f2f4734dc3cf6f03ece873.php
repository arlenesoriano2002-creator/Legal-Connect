...
<body>
 ...
 <section class="hero">
     <img class="bg-img" src="<?php echo e(asset('a.jpg')); ?>" alt="Hero background image" />
        ...
        <div class="reviews-scroll">
          <?php $__empty_1 = true; $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="review-card" style="margin-bottom:16px;">
              <img src="<?php echo e($review->image ? asset('uploads/reviews/'.$review->image) : asset('default-user.png')); ?>"
        ...
        <form id="reviewForm" enctype="multipart/form-data">
          ...
          <?php if(Auth::check()): ?>
            <div class="mb-4">
              ...
              <input type="text" id="name" name="name" value="<?php echo e(Auth::user()->name); ?>" readonly />
            </div>
...
<?php /**PATH D:\xampp\htdocs\LEGAL CONNECT\resources\views/testimonial.blade.php ENDPATH**/ ?>