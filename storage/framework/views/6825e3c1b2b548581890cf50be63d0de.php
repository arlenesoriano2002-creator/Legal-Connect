...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/staff/staff.blade.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/staff/staff-calendar.css')); ?>">
                    ...
                    <div class="view-tabs-container">
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <span style="background: #0d6efd; color: white; padding: 6px 12px; border-radius: 4px; font-weight: 500; font-size: 13px;">
                                📍 <?php echo e(Auth::user()->law_office_id && Auth::user()->lawOffice ? Auth::user()->lawOffice->law_office : 'Diffun Branch'); ?>
                        ...
                        <div id="staffMonthView" class="view-pane">
                            <div class="month-calendar">
                                <div class="calendar-header">
                                    ...
                                    <h3 id="staffCurrentMonthYear"><?php echo e(date('F Y')); ?></h3>
...
<!-- Bootstrap Modal for Logout Confirmation -->
    ...
    <script>
        window.currentUser = {
            ...
            role: '<?php echo e(Auth::user()->role ?? "staff"); ?>'
        };
    ...
    <!-- Custom JS -->
    <script src="<?php echo e(asset('js/staff/staff.js')); ?>"></script>
    <script src="<?php echo e(asset('js/staff/staff-calendar.js')); ?>"></script>
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\staff\staff.blade.php ENDPATH**/ ?>