                    ...
                    fetch(`/appointments/${id}`)
                        ...
                        .then(data => {
                            ...
                            if (!approveForm.querySelector('input[name="_token"]')) {
                                approveForm.innerHTML += `<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">`;
                            }
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\clientstbl.blade.php ENDPATH**/ ?>