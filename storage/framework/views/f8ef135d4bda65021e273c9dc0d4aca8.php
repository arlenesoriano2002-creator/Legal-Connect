                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $recentAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="activity-item">
                                    ...
                                    <div class="activity-status 
                                        <?php if($appointment->appointment_approval == 'pending'): ?> status-pending
                                        <?php elseif($appointment->appointment_approval == 'approved'): ?> status-approved
                                        <?php elseif($appointment->appointment_approval == 'denied'): ?> status-denied
                                        <?php endif; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (createBackupBtn) {
        createBackupBtn.onclick = function() {
            fetch("<?php echo e(route('admin.createBackup')); ?>", {
                method: "POST",
    ...
    <?php if(session('keepArchiveOpen')): ?>
...
</html><?php /**PATH D:\xampp\htdocs\LEGAL CONNECT\resources\views/admindashboard.blade.php ENDPATH**/ ?>