...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/emails/otp.css')); ?>">
</head>
<body>
    <div class="header">
        <h1>Legal Connect</h1>
    ...
    <div class="footer">
        <p>&copy; <?php echo e(date('Y')); ?> Legal Connect. All rights reserved.</p>
    </div>
</body>
</html><?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\emails\otp.blade.php ENDPATH**/ ?>