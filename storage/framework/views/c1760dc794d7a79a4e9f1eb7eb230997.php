    ...
    <div id="wrapper">
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="<?php echo e(route('statistics')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('statistics') ? 'active' : ''); ?>">
                ...
                <div class="card metric-card p-3 h-100">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            ...
                            <h2 class="mb-0"><?php echo e(number_format($totalAppointments)); ?></h2>
                        </div>
                ...
                <div class="card metric-card p-3 h-100">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            ...
                            <h2 class="mb-0"><?php echo e(number_format($walkinsCount)); ?></h2>
                        </div>
                ...
                <div class="card metric-card p-3 h-100">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            ...
                            <h2 class="mb-0"><?php echo e(number_format($pendingCount)); ?></h2>
                        </div>
                ...
                <div class="card metric-card p-3 h-100">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            ...
                            <h2 class="mb-0"><?php echo e(number_format($approvedCount)); ?></h2>
                        </div>
                ...
                <div class="chart-panel">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle stats-table mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $topLawOffices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($office['law_office']); ?></td>
                                        <td><?php echo e($office['requests']); ?></td>
                                        <td><?php echo e($office['approval']); ?>%</td>
                                        <td><span class="badge-status <?php echo e($office['badge']); ?>"><?php echo e($office['status']); ?></span></td>
                                    </tr>
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="card bg-light p-3 border-0">
                                ...
                                <h3 class="mb-0"><?php echo e(number_format($todayNewRequests)); ?></h3>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card bg-light p-3 border-0">
                                <h6 class="text-muted">Approved</h6>
                                <h3 class="mb-0"><?php echo e(number_format($todayApproved)); ?></h3>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card bg-light p-3 border-0">
                                <h6 class="text-muted">Walk-Ins</h6>
                                <h3 class="mb-0"><?php echo e(number_format($todayWalkIns)); ?></h3>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card bg-light p-3 border-0">
                                <h6 class="text-muted">Rejected</h6>
                                <h3 class="mb-0"><?php echo e(number_format($todayRejected)); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
                ...
                datasets: [
                    {
                        ...
                        data: <?php echo json_encode($appointmentTrend, 15, 512) ?>,
                        borderColor: '#4b7bec',
                    ...
                    {
                        label: 'Walk-Ins',
                        data: <?php echo json_encode($walkinTrend, 15, 512) ?>,
                        borderColor: '#1cc88a',
        ...
        new Chart(statusCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($approvedCount); ?>, <?php echo e($pendingCount); ?>, <?php echo e($rejectedCount); ?>],
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\statistics.blade.php ENDPATH**/ ?>