...
<body>
                ...
                <div class="dashboard-container">
                    ...
                    <section class="office-grid">
                        <?php $__empty_1 = true; $__currentLoopData = $offices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <article class="office-card office-item" data-search="<?php echo e(strtolower(trim(($office->law_office ?? '') . ' ' . ($office->lawyer ?? '') . ' ' . ($office->address ?? '')))); ?>">
                                <h3><?php echo e($office->law_office); ?></h3>
                                <p><?php echo e($office->address); ?></p>
                                <p class="mt-2"><strong>Lawyer:</strong> System Generated</p>
                                <div class="office-card-actions">
                                    <button class="action-btn action-btn-edit" type="button" data-bs-toggle="modal" data-bs-target="#editOfficeModal<?php echo e($office->id); ?>">
                                        <i class="fas fa-pen"></i> Edit
                                    </button>
                                    <button class="action-btn action-btn-delete" type="button" data-bs-toggle="modal" data-bs-target="#deleteOfficeModal<?php echo e($office->id); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="content-modal">
                    ...
                    <form class="modal-form-grid" method="POST" action="<?php echo e(route('superadmin.lawoffices.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="form_mode" value="create">
                        <div>
                            <label>Lawyer</label>
                            <span>System Generated</span>
                            <input type="hidden" name="lawyer" value="Atty. Lawyer <?php echo e(count($offices) + 1); ?>">
                        </div>
                        <div>
                            <label for="createOfficeAddress">Address</label>
                            <textarea id="createOfficeAddress" name="address" required><?php echo e(old('address')); ?></textarea>
                        </div>
                        <div>
                            <label for="createOfficeName">Law Office</label>
                            <input id="createOfficeName" name="law_office" type="text" value="<?php echo e(old('law_office')); ?>" required>
                        </div>
    ...
    <?php $__currentLoopData = $offices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="modal fade" id="editOfficeModal<?php echo e($office->id); ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="title-header">
                    ...
                    <div class="content-modal">
                        <p class="modal-description">Update the current law office record for <?php echo e($office->law_office); ?>.</p>
                        <form class="modal-form-grid" method="POST" action="<?php echo e(route('superadmin.lawoffices.update', $office)); ?>">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <input type="hidden" name="form_mode" value="edit">
                            <div>
                                <label>Lawyer</label>
                                <span><?php echo e($office->lawyer); ?></span>
                                <input type="hidden" name="lawyer" value="<?php echo e($office->lawyer); ?>">
                            </div>
                            <div>
                                <label for="officeAddress<?php echo e($office->id); ?>">Address</label>
                                <textarea id="officeAddress<?php echo e($office->id); ?>" name="address" required><?php echo e($office->address); ?></textarea>
                            </div>
                            <div>
                                <label for="officeName<?php echo e($office->id); ?>">Law Office</label>
                                <input id="officeName<?php echo e($office->id); ?>" name="law_office" type="text" value="<?php echo e($office->law_office); ?>" required>
                            </div>
                            <div class="modal-footer px-0 pb-0">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        ...
        <div class="modal fade" id="deleteOfficeModal<?php echo e($office->id); ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="title-header">
                   ...
                   <center>
                     <div class="content-modal">
                        ...
                        <p>Are you sure you want to delete <strong><?php echo e($office->law_office); ?></strong> assigned to <?php echo e($office->lawyer); ?>?</p>
                    </div>
                   </center>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <form method="POST" action="<?php echo e(route('superadmin.lawoffices.destroy', $office)); ?>">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\superadmin\lawoffices.blade.php ENDPATH**/ ?>