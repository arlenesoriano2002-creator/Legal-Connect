        ...
        <div class="calendar-section">
            <div class="calendar-header">
                ...
                <div class="branch-info">
                    ...
                    <span id="selectedBranch"><?php echo e(session('branch', 'Diffun Branch Office')); ?></span>
                </div>
            </div>
...
<script>
    ...
    const selectedBranch = "<?php echo e(session('branch', 'Diffun Branch Office')); ?>";
    const lawOfficeId = <?php echo e($lawOfficeId ?? 'null'); ?>;
    ...
    function getApiEndpoints() {
        if (selectedBranch === 'Cordon Branch Office') {
            ...
            return {
                ...
                bookSlot: '<?php echo e(route("appointment.book.week.slot")); ?>'
            };
        }
    }
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\getsched.blade.php ENDPATH**/ ?>