...
<head>
    ...
    ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/sms-chat.blade.css')); ?>">
...
<body>
        ...
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="#messagesSubmenu" 
                    class="list-group-item list-group-item-action <?php echo e(request()->is('email-chat') || request()->is('admin/sms-chat') || request()->is('admin/system-chat') ? 'active' : ''); ?>"
                    data-bs-toggle="collapse" 
                    aria-expanded="<?php echo e(request()->is('email-chat') || request()->is('admin/sms-chat') || request()->is('admin/system-chat') ? 'true' : 'false'); ?>">
                    <i class="fas fa-envelope"></i>
                    <span>Messages</span>
                    <i class="fas fa-chevron-down"></i>
                </a>
                <div class="submenu collapse <?php echo e(request()->is('email-chat') || request()->is('admin/sms-chat') || request()->is('admin/system-chat') ? 'show' : ''); ?> list-group" id="messagesSubmenu">
                    ...
                    <a href="<?php echo e(route('messages.sms')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->is('admin/sms-chat') ? 'active' : ''); ?>">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="sms-chat-container">
                ...
                <div class="sms-sidebar">
                    ...
                    <div id="users-section-content" class="section-content collapsed">
                        <div id="users-list">
                            <?php if($users->count() > 0): ?>
                                ...
                                <div class="contact-item" onclick="selectUser('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>', '<?php echo e($user->cp_number); ?>')">
                                    <div class="contact-name"><?php echo e($user->name); ?></div>
                                    <div class="contact-phone"><?php echo e($user->cp_number ? formatPhone($user->cp_number) : 'No phone number'); ?></div>
                                </div>
                    ...
                    <?php if($smsConversations->count() > 0): ?>
                    ...
                    <div id="conversations-section-content" class="section-content collapsed">
                        <div id="sms-conversations-list">
                            <?php $__currentLoopData = $smsConversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userId => $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="contact-item" onclick="selectUser('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>', '<?php echo e($user->cp_number); ?>')">
                                    <div class="contact-name"><?php echo e($user->name); ?></div>
                                    <div class="contact-phone"><?php echo e(formatPhone($user->cp_number)); ?></div>
    ...
    <script src="<?php echo e(asset('js/sms-chat.js')); ?>"></script>
        ...
        function initializeSmsChat() {
            ...
            if (newSmsForm) {
                ...
                newSmsForm.addEventListener('submit', function(e) {
                    ...
                    fetch('<?php echo e(url('/admin/sms-send')); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
    ...
    // Make AJAX request
    fetch("<?php echo e(route('sms.send')); ?>", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
</html><?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\admin\sms-chat.blade.php ENDPATH**/ ?>