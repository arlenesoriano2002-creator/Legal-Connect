...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/forgot-password/reset.css')); ?>">
    ...
    <div class="forgot-container">
        ...
        <div class="forgot-card">
            ...
            <form method="POST" action="<?php echo e(route('password.reset')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="email" value="<?php echo e(session('password_reset_email') ?? session('email') ?? old('email')); ?>">
                ...
                <div class="btn-group">
                    ...
                    <button type="button" class="back-btn" onclick="window.location.href='<?php echo e(route('password.otp')); ?>'">Back</button>
                </div>
            </form>
        </div>
    </div>
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\forgot-password\reset.blade.php ENDPATH**/ ?>