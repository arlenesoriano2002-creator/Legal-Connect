                        ...
                        <div class="settings-wrapper">
                            <div class="settings-card recovery-card">
                                ...
                                <?php if($isEmailStep): ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.account.settings.forgot-password.send')); ?>">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="actions d-flex gap-2">
                                            <a href="<?php echo e(route('admin.account.settings')); ?>" class="btn btn-secondary btn-lg w-50">Back to Settings</a>
                                ...
                                <?php if($isVerifyStep): ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.account.settings.forgot-password.verify.submit')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group mb-4">
                                        ...
                                        <div class="actions d-flex gap-2">
                                            <a href="<?php echo e(route('admin.account.settings.forgot-password.email')); ?>" class="btn btn-secondary btn-lg w-50">Change Email</a>
                                ...
                                <?php if($isResetStep): ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.account.settings.forgot-password.reset.submit')); ?>">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="actions d-flex gap-2">
                                            <a href="<?php echo e(route('admin.account.settings.forgot-password.verify')); ?>" class="btn btn-secondary btn-lg w-50">Back to Verification</a>
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\admin-account-setting\forgotPassword.blade.php ENDPATH**/ ?>