...
.time-slot-description:focus {
    border-color: #86b7fe !important;
    outline: 0;
    box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25) !important;
}

.time-slot-row.selected .time-slot-description {
    background-color: white !important;
    border-color: #ced4da !important;
}

/* Ensure input fields don't inherit row styles */
.time-slot-row td:nth-child(3) {
...
</html><?php /**PATH D:\xampp\htdocs\LEGAL CONNECT\resources\views/administrator.blade.php ENDPATH**/ ?>