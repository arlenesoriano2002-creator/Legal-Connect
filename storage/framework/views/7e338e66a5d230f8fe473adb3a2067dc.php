...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/TermsOfService.blade.css')); ?>">
...
<body>
    <div class="container" role="main" aria-label="Terms of Service">
        ...
        <div class="content">
            ...
            <form method="POST" action="<?php echo e(route('terms.accept')); ?>" id="termsForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="btn-group">
                    ...
                    <button class="btn btn-decline" type="button" onclick="window.location.href='<?php echo e(route('welcome')); ?>'">Back</button>
                </div>
            </form>
        </div>
    </div>

    <script src="<?php echo e(asset('js/terms.js')); ?>"></script>
</body>
</html><?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\Terms.blade.php ENDPATH**/ ?>