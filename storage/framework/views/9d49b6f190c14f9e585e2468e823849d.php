    ...
    <div id="wrapper">
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="<?php echo e(route('secretary.lawyers')); ?>" class="list-group-item list-group-item-action <?php echo e(request()->routeIs('secretary.lawyers') ? 'active' : ''); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="content-modal">
                    ...
                    <form class="modal-form-grid" method="POST" action="<?php echo e(route('secretary.lawyers.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="content-modal">
                        ...
                        <form class="modal-form-grid" method="POST" action="<?php echo e(route('secretary.lawyers.update', $lawyer)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <center>
                        ...
                        <p>Are you sure you want to delete <?php echo e($lawyer->name ?? 'this lawyer'); ?> from the lawyers list?</p>
                    </div>
                    </center>
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\secretary\lawyers.blade.php ENDPATH**/ ?>