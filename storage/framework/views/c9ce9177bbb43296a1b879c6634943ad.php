...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/staff/walkInsLogs.blade.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/staff/walkInsLogs-table.css')); ?>">
</head>
<body>
    <div id="wrapper">
        <!-- Sidebar -->
                ...
                <div class="container-fluid py-4">
                   ...
                   <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('staff.purpose.choices')); ?>" class="btn btn-info">
                                <i class="fas fa-list-check me-1"></i> Purpose Choices
                            </a>
                            <!-- Excel Export Form -->
                            <form id="excelExportForm" action="<?php echo e(route('staff.walkins.logs.export.excel')); ?>" method="POST" style="display: inline;">
                                <?php echo csrf_field(); ?>
                            ...
                            <!-- PDF Export Form -->
                            <form id="pdfExportForm" action="<?php echo e(route('staff.walkins.logs.export.pdf')); ?>" method="POST" style="display: inline;">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="filter-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" id="purposeFilter">
                                                ...
                                                <?php if(isset($purposes) && count($purposes) > 0): ?>
                                                    <?php $__currentLoopData = $purposes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purpose): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($purpose->purpose); ?>"><?php echo e($purpose->purpose); ?></option>
                                    ...
                                    <tbody>
                                        <?php if(isset($walkins) && count($walkins) > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($walkin->office_name ?? 'N/A'); ?></td>
                                                <td>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody id="backupLogsList">
                            <?php if(isset($backupLogs) && $backupLogs->count() > 0): ?>
                                <?php $__currentLoopData = $backupLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $fileExtension = strtoupper(pathinfo($backup->decrypted_name, PATHINFO_EXTENSION));
                                ?>
                                    <tr class="backup-item" 
                                        data-id="<?php echo e($backup->id); ?>" 
                                        data-name="<?php echo e($backup->decrypted_name); ?>"
                                        data-date="<?php echo e($backup->formatted_date); ?>"
                                        data-type="<?php echo e($fileExtension); ?>"
                                        data-size="<?php echo e($backup->file_size ?? 'N/A'); ?>">
                                        <td><?php echo e($backup->decrypted_name); ?></td>
                                       
                                        <td><?php echo e($backup->formatted_date); ?></td>
                                        <td>
...
<div class="modal fade" id="logbookPasswordModal" tabindex="-1" aria-labelledby="logbookPasswordModalLabel" aria-hidden="true">
    ...
    <script src="<?php echo e(asset('js/staff/walkInLogs.js')); ?>"></script>
...
</html><?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\staff\walkInsLogs.blade.php ENDPATH**/ ?>