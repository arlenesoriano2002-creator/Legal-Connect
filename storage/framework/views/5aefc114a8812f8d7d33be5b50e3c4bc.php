...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin-account-setting/forgotPassword.css')); ?>">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid mt-4">
            <div class="page-description">
                ...
                <p class="text-muted">Verify your email, confirm the code, and reset your staff password without leaving the staff area.</p>
            </div>
                    ...
                    <div class="settings-wrapper">
                        <div class="settings-card recovery-card">
                            <div class="recovery-step-badges">
                                <span class="recovery-step-badge <?php echo e($isEmailStep ? 'active' : ''); ?>">1. Email</span>
                                <span class="recovery-step-badge <?php echo e($isVerifyStep ? 'active' : ''); ?>">2. Verification</span>
                                <span class="recovery-step-badge <?php echo e($isResetStep ? 'active' : ''); ?>">3. Reset Password</span>
                            </div>
                            ...
                            <?php if($isEmailStep): ?>
                                ...
                                <p class="text-muted mb-4">
                                    Enter the email address for your current staff account. A 6-digit verification code will be sent using the configured SMTP mailer.
                                </p>

                                <form method="POST" action="<?php echo e(route('staff.account.settings.forgot-password.send')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-group mb-4">
                                        <label class="form-label fw-semibold">Email Address</label>
                                        <div class="input-wrapper">
                                            <input type="email" name="email" class="form-control" value="<?php echo e($recoveryEmail); ?>" required>
                                        </div>
                                    </div>

                                    <div class="actions d-flex gap-2">
                                        <a href="<?php echo e(route('staff.account.settings')); ?>" class="btn btn-secondary btn-lg w-50">Back to Settings</a>
                            ...
                            <?php if($isVerifyStep): ?>
                                ...
                                <div class="recovery-meta">
                                    <div><strong>Email:</strong> <?php echo e($resetState['email'] ?? $user->email); ?></div>
                                    <div><strong>Code Length:</strong> 6 digits</div>
                                    <div><strong>Expiration:</strong> <?php echo e(\Carbon\Carbon::parse($resetState['expires_at'])->format('M d, Y h:i A')); ?></div>
                                </div>

                                <form method="POST" action="<?php echo e(route('staff.account.settings.forgot-password.verify.submit')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-group mb-4">
                                        <label class="form-label fw-semibold">Verification Code</label>
                                        <div class="input-wrapper">
                                            <input type="text" name="verification_code" class="form-control verification-code-input" inputmode="numeric" maxlength="6" pattern="\d{6}" value="<?php echo e(old('verification_code')); ?>" required>
                                        </div>
                                        <small class="text-muted d-block mt-2">Enter the exact 6-digit code sent to your email. The code expires automatically.</small>
                                    </div>

                                    <div class="actions d-flex gap-2">
                                        <a href="<?php echo e(route('staff.account.settings.forgot-password.email')); ?>" class="btn btn-secondary btn-lg w-50">Change Email</a>
                            ...
                            <?php if($isResetStep): ?>
                                ...
                                <div class="recovery-meta">
                                    <div><strong>Verified Email:</strong> <?php echo e($resetState['email'] ?? $user->email); ?></div>
                                    <div><strong>Reset Window Ends:</strong> <?php echo e(\Carbon\Carbon::parse($resetState['reset_expires_at'])->format('M d, Y h:i A')); ?></div>
                                </div>

                                <form method="POST" action="<?php echo e(route('staff.account.settings.forgot-password.reset.submit')); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="actions d-flex gap-2">
                                        <a href="<?php echo e(route('staff.account.settings.forgot-password.verify')); ?>" class="btn btn-secondary btn-lg w-50">Back to Verification</a>
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\staff\forgotPassword.blade.php ENDPATH**/ ?>