...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/archivedAppointments.blade.css')); ?>">
        ...
        <aside class="sidebar" role="complementary" aria-label="Sidebar navigation">
            <div>
                <div class="logo-container">
                    <img src="<?php echo e(asset('KG2025 (2).png')); ?>" alt="LegalConnect logo" width="80" height="80"/>
                    <p>LegalConnect</p>
                </div>
                <nav>
                    <a href="<?php echo e(url('/admindashboard')); ?>" class="not-active">Dashboard</a>
                    <a href="<?php echo e(url('/administrator')); ?>" class="not-active">Set Appointment</a>
                    <a href="<?php echo e(url('/clientstbl')); ?>" class="not-active">Pending Request</a>
                    <a href="<?php echo e(url('/adminAcceptedRequest')); ?>" class="not-active">Accepted Request</a>
                    <a href="<?php echo e(url('/adminDeniedRequest')); ?>" class="not-active">Denied Request</a>
                    <a href="<?php echo e(url('/admin/archived')); ?>" class="active">Archived</a>
                    <a href="<?php echo e(route('messages.page')); ?>" class="not-active">Messages</a>
                    <a href="<?php echo e(url('/adminAccount')); ?>" class="not-active">Account</a>
                </nav>
            </div>
        </aside>
                        ...
                        <table class="admin-table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $backups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($b['name'] ?? $b->file_name); ?></td>
                                        <td><?php echo e($b['mtime'] ?? $b->created_at); ?></td>
                                        <td><?php echo e(isset($b['size']) ? round($b['size']/1024, 2) : '-'); ?></td>
                                        <td>
                                            <?php
                                            ...
                                            <?php if($filename): ?>
                                                <a href="<?php echo e(route('admin.download.backup', ['filename' => $filename])); ?>" class="btn btn-success btn-sm">
                                                    Download
                                                </a>
                                            <?php else: ?>
                        ...
                        <table class="admin-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="image-btn" data-src="<?php echo e(asset('storage/' . $appointment->id_front)); ?>">
                                            View Front
                                        </button>
                                    </td>
                                    <td>
                                        <button type="button" class="image-btn" data-src="<?php echo e(asset('storage/' . $appointment->id_back)); ?>">
                                            View Back
                                        </button>
                                    </td>
                                </tr>
...
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\archivedAppointments.blade.php ENDPATH**/ ?>