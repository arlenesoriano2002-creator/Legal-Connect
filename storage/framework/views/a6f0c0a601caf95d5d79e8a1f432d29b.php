...
<body>
    ...
    <div class="content">
        ...
        <div class="info-box">
            ...
            <ul>
                <li>Account: <?php echo e($email); ?></li>
                <li>Changed on: <?php echo e($timestamp); ?></li>
                <li>IP Address: <?php echo e($ip_address); ?></li>
            </ul>
        </div>
    ...
    <div class="footer">
        ...
        <p>© <?php echo e(date('Y')); ?> LegalConnect. All rights reserved.</p>
    </div>
</body>
</html><?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\emails\password-changed-confirmation.blade.php ENDPATH**/ ?>