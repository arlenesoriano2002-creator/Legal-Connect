...
<!-- Bootstrap Modal for Logout Confirmation -->
  ...
  <script src="<?php echo e(asset('js/staff/StaffClientstbl.js')); ?>"></script>
    <script src="<?php echo e(asset('js/staff/diffunNotifications.js')); ?>"></script>

</body>
</html>
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\staff\StaffClientstbl.blade.php ENDPATH**/ ?>