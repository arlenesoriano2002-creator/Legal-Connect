                ...
                <form method="POST" action="<?php echo e(route('otp.verify')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="otp" name="otp" placeholder="Enter 4-digit Code" required maxlength="4" value="<?php echo e(old('otp')); ?>">
                        </div>
                    </div>
                    
                    <button type="submit" class="btn btn-primary">Verify Code</button>
                    <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo e(url('/register')); ?>'">Back</button>
                </form>
...
</html><?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\auth\verify-otp.blade.php ENDPATH**/ ?>