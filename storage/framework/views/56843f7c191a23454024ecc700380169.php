...
<body>
                            ...
                            <div class="card-body text-center">
                                <?php if(isset($user)): ?>
                                    <div class="profile-image mb-3">
                                        <img src="<?php echo e(asset($user->image ?: 'uploads/default-avatar.png')); ?>" 
                                             alt="Admin Image" 
                                    ...
                                    <p class="text-muted"><strong>Role:</strong> <?php echo e($user->role); ?></p>
                                    <p class="text-muted"><strong>Email:</strong> <?php echo e($user->email ?? 'N/A'); ?></p>
                                    <p class="text-muted"><strong>Contact:</strong> <?php echo e($user->cp_number ?? 'N/A'); ?></p>
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $staffUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo e(asset($staff->image ?: 'uploads/default-avatar.png')); ?>" 
                                                             alt="Staff Image" 
                                                             class="rounded-circle" 
                                                             width="40" 
                                                             height="40"
                                                    ...
                                                    <td>
                                                        <button onclick="openEditStaffModal(<?php echo e($staff); ?>)" 
    ...
    <div id="adminModal" class="modal">
        <div class="modal-content">
            <h3>Edit Profile</h3>
            <form action="<?php echo e(route('adminAccount.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="cp_number" value="<?php echo e($user->cp_number ?? ''); ?>" class="form-control">
                </div>

                <div class="mb-3">
                    <label for="role" class="form-label">Role:</label>
                    <input type="text" name="role" value="<?php echo e($user->role ?? ''); ?>" required class="form-control">
                </div>
    ...
    <div id="createStaffModal" class="modal">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('adminAccount.staff.create')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function openEditStaffModal(staff) {
            ...
            form.action = '<?php echo e(url("adminAccount/staff/update")); ?>/' + staff.id;
        }
        ...
        function confirmDelete(staffId) {
            ...
            form.action = '<?php echo e(url("adminAccount/staff/delete")); ?>/' + staffId;
        }
...
</html><?php /**PATH D:\xampp\htdocs\LEGAL CONNECT\resources\views/adminAccount.blade.php ENDPATH**/ ?>