...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/staff/staffDeniedRequest.blade.css')); ?>">
</head>
<body>
    <div id="wrapper">
       <!-- Sidebar -->
                                ...
                                <tbody>
                                    ...
                                    <tr id="appointment-<?php echo e($appointment->id); ?>">
                                        ...
                                        <td>
                                            ...
                                            <td>
                                            <button class="btn btn-info btn-sm view-btn" data-id="<?php echo e($appointment->id); ?>">
...
<!-- Bootstrap Modal for Logout Confirmation -->
  ...
  <script src="<?php echo e(asset('js/staff/staffDeniedRequest.js')); ?>"></script>
    <script src="<?php echo e(asset('js/staff/diffunNotifications.js')); ?>"></script>

</body>
</html>
<?php /**PATH D:\xampp\htdocs\Legal connect final\LegalConnect\resources\views\staff\staffDeniedRequest.blade.php ENDPATH**/ ?>