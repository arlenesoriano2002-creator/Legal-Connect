...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/clientstbl.blade.css')); ?>">
</head>
<body>
    <div id="wrapper">
        <!-- Sidebar -->
                    ...
                    <div class="modal-left">
                        ...
                        <div class="modal-actions">
                            ...
                            <form id="denyForm" method="POST" action="">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="deny-btn">
            ...
            button.addEventListener('click', function () {
                ...
                fetch(`/appointments/${id}`)
                    ...
                    .then(data => {
                        ...
                        // Set form actions
                        document.getElementById('approveForm').action = `/appointments/${data.id}/approve`;
                        document.getElementById('denyForm').action = `/appointments/${data.id}/deny`;
...
</html><?php /**PATH D:\xampp\htdocs\LEGAL CONNECT\resources\views/clientstbl.blade.php ENDPATH**/ ?>